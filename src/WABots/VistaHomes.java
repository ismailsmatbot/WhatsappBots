...
public class VistaHomes {
	public static void main(String args[]) throws Exception {
		...
		driver.findElement(By.xpath("//*[@id=\"side\"]/div[1]/div/label/div/div[2]")).sendKeys("Vista homes");
		Thread.sleep(1000);
		Robot r = new Robot();
		...
		Thread.sleep(6000);
		driver.findElement(By.xpath("(//div[@class='_1U18t'])[3]")).click();
